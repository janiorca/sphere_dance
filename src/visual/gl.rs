...
const ClearColorIdx: u16 = 592;
const ClearIdx: u16 = 593;
...
//    (DrawArraysIdx, "glDrawArrays\0"),
    ...
    (VertexAttribPointerIdx, "glVertexAttribPointerIdx\0"),
...
pub unsafe fn ClearColor(red: f32, green: f32, blue: f32, alpha: f32) {
    mem::transmute::<_, extern "system" fn(f32, f32, f32, f32)>(*GL_API.get_unchecked(ClearColorIdx as usize))(red, green, blue, alpha)
}

pub unsafe fn Clear(bits: GLenum) {
    mem::transmute::<_, extern "system" fn(GLenum)>(*GL_API.get_unchecked(ClearIdx as usize))(bits)
}
